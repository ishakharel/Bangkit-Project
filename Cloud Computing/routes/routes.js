...
router.put("/user/profile/", checkApiKey, checkAuth, multerConfig, userController.changeImage);
router.delete("/user/notif/:id", checkApiKey, checkAuth, userController.deleteNotificationById);
...
router.get("/waste/categories/:category_id", checkApiKey, wasteController.categoryById);
